...
const Getprompt = (mode, answer, question, Property) => {
  try{
  ...
  The Below is the data of the the Properties Exist in the DataBase 
  ...
  5.RECOMMENDED_PROPERTIES:
    - In the Recommended properties Add the Properties form the Database  
  ...
  {
    console.log("Somenthing went wrong in the" , error)
  }
};
